...
export default function TodoInput({ onAddTask }) {
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between w-full gap-4 px-3 py-2 mb-4 leading-tight text-gray-700 bg-white border rounded dark:border-sky-700 dark:bg-sky-900">
        <input
          value={newTask}
